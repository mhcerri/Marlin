...
// Move the EEPROM memory to avoid issues
// https://github.com/MarlinFirmware/Marlin/issues/15254#issuecomment-535755449
#define EEPROM_START_ADDRESS uint32(0x8000000 + 256 * (2 * 1024) - 2 * EEPROM_PAGE_SIZE)
#undef E2END
